...
const SearchComponent = ({
  ...
  const [inputDate, setInputDate] = useState(initialStartDate);
  const [title, setTitle] = useState(initialTitle);
  const [author, setAuthor] = useState(initialAuthor);
  const [returnDate, setReturnDate] = useState(initialEndDate);
  ...
  return (
    <div className="mt-30 flex gap-8.5 justify-between">
